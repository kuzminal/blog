...
import com.kuzmin.blog.constants.BlogConstants;
import com.kuzmin.blog.constants.BlogStatus;
import com.kuzmin.blog.constants.CommentStatus;
import com.kuzmin.blog.model.Blog;
import com.kuzmin.blog.model.Comment;
import com.kuzmin.blog.service.BlogService;
...
public class BlogController {
    ...
    public String showAddNew(Model model) {
        ...
        setProcessingData(model, BlogConstants.TITLE_NEW_BLOG_PAGE);
        return "add-new";
    }
    ...
    public String showManageBlogPage(Model model) {
        ...
        setProcessingData(model, BlogConstants.TITLE_MANAGE_BLOG_PAGE);
    ...
    public String viewBlog(@RequestParam(value = "blogId",required = true) String blogId, Model model) {
        ...
        setProcessingData(model, BlogConstants.TITLE_VIEW_BLOG_PAGE);
        return "view-blog";
    }
    ...
    public String addComment(@RequestParam(value = "blogId",required = true) String blogId,
        ...
        if(blogId !=null) {
            ...
            if(blog !=null) {
                ...
                blogComment.setId(BlogUtil.RandonmNumber(currentDate));
